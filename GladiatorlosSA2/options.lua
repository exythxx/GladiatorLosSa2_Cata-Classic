					...
					spellAuraApplied = {
						...
						args = {
							...
							druid = { -- AuraApplied
								...
								order = 70,
								args = listOption({16870,22812,29166,16689,53201,50334,5229,22842,52610,61336,69369,17116, 48505},"auraApplied"),
							},
							hunter = { -- AuraApplied
								type = 'group',
								inline = true,
							...
							paladin = { -- AuraApplied
								...
								order = 110,
								args = listOption({1044,498,31821,10278,642,31884,6940,6940,1038,20216,20375,31842,20178,10308,54428,53563,53601, 85696, 1022},"auraApplied"),
							},
							priest	= { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 120,
								args = listOption({33206,10060,6346,14751,15286,552,47788,47585,48066,586,15473, 87153, 87152},"auraApplied"),
							},
							rogue = { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 130,
								args = listOption({26669,31224,14177,13750,51690,1833,11297,26884,51713,57934,45182, 74001},"auraApplied"),
							},
							shaman	= { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 140,
								args = listOption({16166,30823,16188,974,16188,57960, 79206},"auraApplied"),
							},
							warlock	= { -- AuraApplied
								type = 'group',
								inline = true,
							...
							warrior	= { -- AuraApplied
								...
								order = 160,
								args = listOption({55694,46924,2687,871,18499,1719,23920,12292,12975,20230,23881, 85730},"auraApplied"),
							},
							dk	= {
								type = 'group',
								inline = true,
					...
					spellAuraRemoved = {
						...
						args = {
							...
							druid = { -- AuraRemoved
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 60,
								args = listOption({22812,29166,53312,53201,50334,33357,5229,22842,52610,61336,69369,17116, 48505},"auraRemoved"),
							},
							hunter = { -- AuraRemoved
								type = 'group',
								inline = true,
							...
							paladin = { -- AuraRemoved
								...
								name = L["|cffF58CBAPaladin|r"],
								order = 100,
								args = listOption({31821,53563,31842,54428,53601,25771,498,642,6940,20216,1044,6940,1038,20178,31884, 1022},"auraRemoved"),
							},
							priest	= { -- AuraRemoved
								type = 'group',
								inline = true,
							...
							rogue = { -- AuraRemoved
								...
								name = L["|cffFFF569Rogue|r"],
								order = 120,
								args = listOption({14177,13750,26669,51690,11305,31224,51713,57934,45182, 74001},"auraRemoved"),
							},
							shaman	= { -- AuraRemoved
								type = 'group',
								inline = true,
...
--[[							bigHeal = { -- CastStart
							...
							druid = { -- CastStart
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 60,
								args = listOption({18658,53308,33786,48465,48447, 2637},"castStart"),
							},
							hunter = { -- CastStart
								type = 'group',
								inline = true,
...
--[[							shaman	= { -- CastStart
							...
							warlock	= { -- CastStart
								...
								name = L["|cff9482C9Warlock|r"],
								order = 140,
								args = listOption({5484,5782,688,697,712,691,30146,6215,17928,47843,18647,30414,47878,47857,5138,47825,48018,59172},"castStart"),
							},
--[[							warrior = { -- CastStart
								type = 'group',
								inline = true,
...
--[[							enemyInterrupts = { -- CastSuccess
							...
							druid = { -- CastSuccess
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 70,
								args = listOption({8946,2782,8983,9913,33357,770,16857,33831,26983,18562,53201,16979,49376,49802,49803,2893, 80964, 78675},"castSuccess"),
							},
							hunter = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							mage = { -- CastSuccess
								...
								name = L["|cff69CCF0Mage|r"],
								order = 90,
								args = listOption({475,1953,2139,45438,42917,66,30449,11113,11958,31687,44445,44572,12051,42987,55342,475,31661,33395, 82676, 11129},"castSuccess"),
							},
							paladin = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffF58CBAPaladin|r"],
								order = 110,
								args = listOption({20271,1152,4987,10308,27154,48825,20066,19746, 96231, 853},"castSuccess"),
							},
							priest	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffFFFFFFPriest|r"],
								order = 120,
								args = listOption({528,552,988,10890,34433,48300,32996,15487,64044,48078,53023, 8122},"castSuccess"),
							},
							rogue = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffFFF569Rogue|r"],
								order = 130,
								args = listOption({2094,8643,8696,11305,1787,26889,1776,1766,14278,14185,36554,51722,51724,13877,51723, 76577, 73981, 1784, 79140},"castSuccess"),
							},
							shaman	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cff0070daShaman|r"],
								order = 140,
								args = listOption({2484,526,8143,2870,8166,8177,8012,49231,8170,2062,2894,2825,32182,16190,8143,51533,59159,51886,8170,526, 98008},"castSuccess"),
							},
--[[							shamanTotems	= { -- CastSuccess
							...
							warlock = { -- CastSuccess
								...
								name = L["|cff9482C9Warlock|r"],
								order = 150,
								args = listOption({17928,19647,47860,47847,48011,47875,48020,6358, 77801, 86121, 6789},"castSuccess"),
							},
							warrior	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffC79C6EWarrior|r"],
								order = 160,
								args = listOption({676,5246,6552,72,29704,11578,20252,3411,12328,12809,2457,71,2458,57755,57823,46968,7386, 97462, 85388},"castSuccess"),
							},
							dk	= {
								type = 'group',
								inline = true,
								name = "|cffC41F3BDeath Knight|r",
								order = 170,
								args = listOption({49941,48266,48263,48265,49005,48982,47476,45524,47568,49203,47528,49938,49576,61999,46584,49206,47481, 77606},"castSuccess"),
							},
							racials = {
								type = 'group',
								inline = true,
